...
class ShmealsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shmeal" do
    assert_difference('Shmeal.count') do
      post shmeals_url, params: { shmeal: { menuItem_id: @shmeal.menuItem_id, shmealDayDate: @shmeal.shmealDayDate, shmealEndTime: @shmeal.shmealEndTime, shmealLat: @shmeal.shmealLat, shmealLon: @shmeal.shmealLon, shmealPostDate: @shmeal.shmealPostDate, shmealQuantity: @shmeal.shmealQuantity, shmealScore: @shmeal.shmealScore, shmealStartTime: @shmeal.shmealStartTime } }, as: :json
    end
  ...
  test "should update shmeal" do
    patch shmeal_url(@shmeal), params: { shmeal: { menuItem_id: @shmeal.menuItem_id, shmealDayDate: @shmeal.shmealDayDate, shmealEndTime: @shmeal.shmealEndTime, shmealLat: @shmeal.shmealLat, shmealLon: @shmeal.shmealLon, shmealPostDate: @shmeal.shmealPostDate, shmealQuantity: @shmeal.shmealQuantity, shmealScore: @shmeal.shmealScore, shmealStartTime: @shmeal.shmealStartTime } }, as: :json
    assert_response 200
  end
