...
class ShmcheckoutsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shmcheckout" do
    assert_difference('Shmcheckout.count') do
      post shmcheckouts_url, params: { shmcheckout: { amount: @shmcheckout.amount, deviceData: @shmcheckout.deviceData, merchantID: @shmcheckout.merchantID, nonce: @shmcheckout.nonce } }, as: :json
    end
  ...
  test "should update shmcheckout" do
    patch shmcheckout_url(@shmcheckout), params: { shmcheckout: { amount: @shmcheckout.amount, deviceData: @shmcheckout.deviceData, merchantID: @shmcheckout.merchantID, nonce: @shmcheckout.nonce } }, as: :json
    assert_response 200
  end
