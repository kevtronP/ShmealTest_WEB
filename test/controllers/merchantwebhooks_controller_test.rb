...
class MerchantwebhooksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create merchantwebhook" do
    assert_difference('Merchantwebhook.count') do
      post merchantwebhooks_url, params: { merchantwebhook: { bt_payload: @merchantwebhook.bt_payload, bt_signature: @merchantwebhook.bt_signature, errorMessages: @merchantwebhook.errorMessages, kind: @merchantwebhook.kind, merchantID: @merchantwebhook.merchantID, message: @merchantwebhook.message, notificationTime: @merchantwebhook.notificationTime } }, as: :json
    end
  ...
  test "should update merchantwebhook" do
    patch merchantwebhook_url(@merchantwebhook), params: { merchantwebhook: { bt_payload: @merchantwebhook.bt_payload, bt_signature: @merchantwebhook.bt_signature, errorMessages: @merchantwebhook.errorMessages, kind: @merchantwebhook.kind, merchantID: @merchantwebhook.merchantID, message: @merchantwebhook.message, notificationTime: @merchantwebhook.notificationTime } }, as: :json
    assert_response 200
  end
