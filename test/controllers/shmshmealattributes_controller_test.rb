...
class ShmshmealattributesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shmshmealattribute" do
    assert_difference('Shmshmealattribute.count') do
      post shmshmealattributes_url, params: { shmshmealattribute: { attributeDate: @shmshmealattribute.attributeDate, attributeName: @shmshmealattribute.attributeName, shmealAttribute: @shmshmealattribute.shmealAttribute, shmealID: @shmshmealattribute.shmealID } }, as: :json
    end
  ...
  test "should update shmshmealattribute" do
    patch shmshmealattribute_url(@shmshmealattribute), params: { shmshmealattribute: { attributeDate: @shmshmealattribute.attributeDate, attributeName: @shmshmealattribute.attributeName, shmealAttribute: @shmshmealattribute.shmealAttribute, shmealID: @shmshmealattribute.shmealID } }, as: :json
    assert_response 200
  end
