...
class ShmshmealattributesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shmshmealattribute" do
    assert_difference('Shmshmealattribute.count') do
      post shmshmealattributes_url, params: { shmshmealattribute: { attributeDate: @shmshmealattribute.attributeDate, attributeName: @shmshmealattribute.attributeName, menuItemID: @shmshmealattribute.menuItemID, shmealAtrbDate: @shmshmealattribute.shmealAtrbDate, shmealAttribute: @shmshmealattribute.shmealAttribute, shmealID: @shmshmealattribute.shmealID } }, as: :json
    end
