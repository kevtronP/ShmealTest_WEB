...
class ShmconversationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shmconversation" do
    assert_difference('Shmconversation.count') do
      post shmconversations_url, params: { shmconversation: { convChannel: @shmconversation.convChannel, originalCookID: @shmconversation.originalCookID, originalEaterID: @shmconversation.originalEaterID } }, as: :json
    end
  ...
  test "should update shmconversation" do
    patch shmconversation_url(@shmconversation), params: { shmconversation: { convChannel: @shmconversation.convChannel, originalCookID: @shmconversation.originalCookID, originalEaterID: @shmconversation.originalEaterID } }, as: :json
    assert_response 200
  end
